...
public class Account {
    ...
    private float valueNextMonthIntrest;
    ...
    public Account(String accountNumber, String accountType, float balance,float monthlyFee) {
        this.accountNumber = accountNumber;
        this.accountType = accountType;
        this.balance = balance;
        ...
        this.valueNextMonthIntrest = valueNextMonth();
    }
	...
	public float getValueNextMonthIntrest() {
		return valueNextMonthIntrest;
	}

	public void setValueNextMonthIntrest(float valueNextMonthIntrest) {
		this.valueNextMonthIntrest = valueNextMonthIntrest;
	}
}
